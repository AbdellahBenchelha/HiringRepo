/**
 * Country dial-code data for the phone-number field.
 * `iso2` is the lowercase ISO 3166-1 alpha-2 code (used to render the flag),
 * `dial` is the international calling code (with leading +).
 */
...
/** Convert a lowercase ISO 3166-1 alpha-2 code into a flag emoji. */
