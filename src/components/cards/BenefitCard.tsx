...
export function BenefitCard({ benefit }: { benefit: Benefit }) {
  return (
    <div className="group flex h-full flex-col rounded-2xl border border-cream-300 bg-white p-6 shadow-soft transition duration-200 hover:-translate-y-1 hover:border-brand-200 hover:shadow-card">
